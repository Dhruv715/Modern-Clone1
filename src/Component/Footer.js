  ...
  return (
    <> 
        <div className='w-4/5 py-14 border-t-2 mx-auto flex'>
            <div className='w-1/4'>
                <h1 className='mt-5 mb-8 font-semibold text-lg' style={{letterSpacing:'2px'}}>CUSTOMER SERVICES</h1>
                <ul className='text-gray-400  text-normal'>
            ...
            <div className='w-1/4'>
                <h1 className='mt-5 mb-8 font-semibold text-lg' style={{letterSpacing:'2px'}}>COMPANY</h1>
                <ul className='text-gray-400  text-normal'>
            ...
            <div className='w-1/4'>
                <h1 className='mt-5 mb-8 font-semibold text-lg' style={{letterSpacing:'2px'}}>SOCIAL MEDIA</h1>
                <ul className='text-gray-400  text-normal'>
            ...
            <div className='w-1/4'>
                <h1 className='mt-5 mb-8 font-semibold text-lg' style={{letterSpacing:'2px'}}>PROFILE</h1>
                <ul className='text-gray-400  text-normal'>
